...
# Path to the CSV file (Please replace your file path)
csv_path = '../../data/all_data_verf.csv'
...
app_ui = ui.page_sidebar(
    ui.sidebar(
        ...
        ui.panel_conditional(
            ...
            ui.input_checkbox_group(
                id="continent_select",
                label="Select Areas:",
                choices=["Africa", "Asia", "South America", "Non-Africa"],  # Limited choices for areas
    ...
    ui.panel_conditional(
        ...
        ui.output_plot("continent_plot", width='900px', height='600px')
    ),
    ui.panel_conditional(
        "input.switch_button == true",  # Show country-level plot when switch is on
        ui.output_plot("country_plot", width='900x', height='600px')
    )
)
...
def server(input, output, session):
    ...
    def load_data():
        ...
        data['Country_x'] = data['Country_x'].astype(str)
    ...
    def update_region_country_choices():
        ...
        continent_country_list = (
            data[['CONTINENT', 'Country_x']]
            .drop_duplicates()
            .apply(lambda row: f"{row['CONTINENT']} - {row['Country_x']}", axis=1)
            .tolist()
        )
    ...
    def continent_plot():
        ...
        colors = {"Africa": "red", "Asia": "blue", "South America": "orange", "Non-Africa": "green"}
    ...
    def country_plot():
        ...
        country_data = data[
            ...
            (data["Country_x"] == selected_country) &
